...
const ITEMS = [
  "Arbeitsplätze, Schreibtische & Bildschirme",
  "Sanitäranlagen & Teeküchen täglich frisch",
  "Boden- & Teppichpflege je nach Belag",
  "Empfang & Eingangsbereich repräsentativ",
  ...
  return (
    <div className="min-h-screen bg-brand-light text-brand-deep font-sans antialiased">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          <div className="lg:col-span-7">
            ...
            <h1 className="mt-6 text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05] text-balance">
              Büro- & <span className="text-brand-bright">Praxisreinigung</span> im Wallis.
            </h1>
            <p className="mt-6 text-lg text-brand-deep/65 max-w-xl leading-relaxed">
              Ihre Räume sind Ihre Visitenkarte. Wir reinigen Büros, Praxen und Geschäftsräume
              diskret ausserhalb Ihrer Öffnungszeiten — mit fixem Plan, geschultem Personal und nach
              Schweizer Standard.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-brand-deep/70">
              <div className="flex items-center gap-2">
                ...
                <span>Diskret ausserhalb der Geschäftszeiten</span>
              </div>
            </div>
          </div>
        ...
        <div id="leistungen" className="max-w-7xl mx-auto scroll-mt-20">
          <Reveal className="rounded-[28px] bg-white border border-brand-deep/5 p-8 md:p-12">
            ...
            <p className="mt-4 text-brand-deep/65 leading-relaxed max-w-2xl">
              Wir übernehmen die Reinigung Ihrer Geschäftsräume nach einem festen, mit Ihnen
              abgestimmten Plan — diskret, zuverlässig und ohne dass Ihr Betrieb gestört wird.
            </p>
      ...
      <CtaBanner
        ...
        body="Erhalten Sie eine kostenlose Offerte für ein Reinigungsabo, das zu Ihrem Betrieb und Ihren Öffnungszeiten passt."
      />
