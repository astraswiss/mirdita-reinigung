...
export const metadata: Metadata = {
  ...
  alternates: alternatesFor("/praxisreinigung"),
  openGraph: {
    title: "Praxis- & Wartezimmerreinigung im Wallis",
    description:
...
const ITEMS = [
  ...
  "Empfang & Anmeldebereich",
  "Sanitäranlagen mit erhöhtem Hygienestandard",
  "Desinfektion von Kontaktflächen & Griffen",
  "Böden & Oberflächen schonend & gründlich",
  "Flexible Termine ausserhalb der Sprechstunden",
];
...
export default async function Page() {
  ...
  return (
    <div className="min-h-screen bg-brand-light text-brand-deep font-sans antialiased">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          <div className="lg:col-span-7">
            ...
            <h1 className="mt-6 text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.05] text-balance">
              Praxis- & <span className="text-brand-bright">Wartezimmerreinigung</span> im Wallis.
            </h1>
            <p className="mt-6 text-lg text-brand-deep/65 max-w-xl leading-relaxed">
              In Arzt-, Zahnarzt- und Therapiepraxen zählt Hygiene besonders. Wir reinigen und
              desinfizieren Behandlungsräume, Wartezimmer und Sanitäranlagen flexibel ausserhalb
              Ihrer Sprechstunden — diskret und nach erhöhten Hygienestandards.
            </p>
            ...
            <div className="mt-10 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm text-brand-deep/70">
              <div className="flex items-center gap-2">
                ...
                <span>Erhöhte Hygienestandards</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <Photo
              src={PHOTO_BUERO}
              alt="Heller, moderner Empfangs- und Praxisbereich nach der Reinigung"
        ...
        <div id="leistungen" className="max-w-7xl mx-auto scroll-mt-20">
          <Reveal className="rounded-[28px] bg-white border border-brand-deep/5 p-8 md:p-12">
            ...
            <p className="mt-4 text-brand-deep/65 leading-relaxed max-w-2xl">
              Neben der klassischen Büroreinigung legen wir bei Praxen besonderen Wert auf Hygiene —
              mit gezielter Desinfektion von Kontaktflächen und Materialien, die für medizinische
              Räume geeignet sind.
            </p>
      ...
      <ProcessSteps title="In vier Schritten zur hygienischen Praxis" />
      ...
      <CtaBanner
        title="Hygiene, auf die Sie sich verlassen können."
        body="Fordern Sie eine kostenlose Offerte für die Reinigung Ihrer Praxis an — wir planen rund um Ihre Sprechstunden."
      />
