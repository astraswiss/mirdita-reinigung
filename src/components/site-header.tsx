...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-50 px-5 md:px-10 pt-4">
      <div className="max-w-7xl mx-auto h-16 flex items-center justify-between gap-6 rounded-full border border-brand-deep/5 bg-brand-light/85 backdrop-blur shadow-sm shadow-brand-deep/5 px-5 md:px-6">
      ...
      {mobileOpen && (
        <div className="md:hidden max-w-7xl mx-auto mt-2 rounded-3xl border border-brand-deep/5 bg-brand-light shadow-sm shadow-brand-deep/5 px-5 py-4 space-y-3">
          {NAV.map((n) => (
            <a
              key={n.href}
              href={n.href}
